...
<form>
	<div id="article-content" align="left">
       	<div style="float: left; width: 20%; height:90px; padding-top: 30px;" align="center"><h2 align="center">주 소 정 보</h2></div>
...
<form>
	<div id="article-content" align="left">
       	<div style="float: left; width: 20%; height:90px; padding-top: 30px;" align="center"><h2 align="center">전 화 번 호</h2></div>
       	<div style="float: left; border-left:1px solid #bcbcbc; height: 90px; padding-left: 5px;">
       		<div style="width: 500px; padding: 5px;">
...
<form>
	<div id="article-content" align="left">
       	<div style="float: left; width: 20%; height:90px; padding-top: 30px;" align="center"><h3 align="center">주문 시 요청사항</h3></div>
       	<div style="float: left; border-left:1px solid #bcbcbc; height: 90px; padding-left: 5px;">
...
<form>
	<div id="article-content" align="left">
       	<div style="float: left; width: 20%; height:90px; padding-top: 30px;" align="center"><h2 align="center">포인트 내역</h2></div>
       	<div style="float: left; border-left:1px solid #bcbcbc; height: 90px; padding-left: 5px;">
       		<div style="width: 500px; padding: 5px;">
       			<div style="width: 120px; float: left; margin-top: 5px; margin-bottom: 8px;">누 &nbsp;적 &nbsp;포&nbsp; 인&nbsp; 트  : </div>
       			<div style="width: 380px; float: left; margin-top: 5px; margin-bottom: 8px;">300 point</div>
       			<div style="width: 120px; float: left; margin-bottom: 8px;">사용 가능 포인트 : </div>
       			<div style="width: 380px; float: left; margin-bottom: 8px;">300 point</div>
       			<div style="width: 120px; float: left; margin-bottom: 8px;">발생 예정 포인트 : </div>
       			<div style="width: 380px; float: left; margin-bottom: 8px;">300 point</div>
			</div>
       	</div>
	</div>
...
<form>
	<div id="article-content-pay" align="left">
       	<div style="float: left; width: 20%; height:100px; padding-top: 32px;" align="center"><h2 align="center">결 제 방 법</h2></div>
