        ...
        <div>
			...
			<tr height="35" style="border-bottom: 1px solid #cccccc;">
			    <td colspan="2" align="left" style="padding-left: 5px;">
			       이전글 :	<c:if test="${not empty preDto}"><a href="${articleUrl}&num=${preDto.num}">${preDto.subject}</a></c:if>
							<c:if test="${empty preDto}">${massege}</c:if>
			...
			<tr height="35" style="border-bottom: 1px solid #cccccc;">
			    <td colspan="2" align="left" style="padding-left: 5px;">
			       다음글 :	<c:if test="${not empty nextDto}"><a href="${articleUrl}&num=${nextDto.num}">${nextDto.subject}</a></c:if>
							<c:if test="${empty nextDto}">${massege}</c:if>
			    </td>
			</tr>
			</table>
